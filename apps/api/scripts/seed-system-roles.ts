...
const PERMISSIONS = [
  {
    ...
    resource: 'dashboard',
    action: 'read',
    description: 'View employee dashboard',
  },
  {
    name: 'executive-dashboard:read',
    resource: 'executive-dashboard',
    action: 'read',
    description: 'View executive dashboard',
  },
  {
    name: 'hr-dashboard:read',
    resource: 'hr-dashboard',
    action: 'read',
    description: 'View HR dashboard',
  },
  {
    name: 'department-head-dashboard:read',
    resource: 'department-head-dashboard',
    action: 'read',
    description: 'View supervisor dashboard',
  },
  {
    name: 'permanent-employees:read',
    resource: 'permanent-employees',
    action: 'read',
    description: 'View permanent employee imports',
  },
  {
    name: 'employees:read',
    resource: 'employees',
  ...
  },
  {
    ...
    action: 'read',
    description: 'View temporary department assignments',
  },
  {
    name: 'temporary-assignment:add',
    resource: 'temporary-assignment',
    action: 'add',
    description: 'Create temporary department assignments',
  },
  {
    name: 'temporary-assignment:edit',
    resource: 'temporary-assignment',
    action: 'edit',
    description: 'Update temporary department assignments',
  },
  {
    name: 'leave-fiscal-years:read',
    resource: 'leave-fiscal-years',
    action: 'read',
    description: 'View leave fiscal years',
  },
  {
    name: 'leave-types:read',
  ...
  },
  {
    ...
    resource: 'leave-request-approvals',
    action: 'approve',
  ...
  },
  {
    ...
    action: 'read',
    description: 'View annual leave requests',
  },
  {
    name: 'other-leave-requests:read',
    resource: 'other-leave-requests',
    action: 'read',
    description: 'View other leave requests',
  },
  {
    name: 'overtime-requests:read',
    resource: 'overtime-requests',
    action: 'read',
    description: 'View overtime assignments',
  },
  {
    name: 'overtime-requests:approve',
    resource: 'overtime-requests',
    action: 'approve',
    description: 'Assign and approve overtime for supervised employees',
  },
  {
    name: 'manual-punch-requests:read',
    resource: 'manual-punch-requests',
    action: 'read',
    description: 'View attendance correction requests',
  },
  {
    name: 'manual-punch-requests:approve',
    resource: 'manual-punch-requests',
    action: 'approve',
    description: 'Approve attendance correction requests',
  },
  {
    name: 'work-schedules:read',
  ...
  },
  {
    ...
    resource: 'holidays',
    action: 'read',
    description: 'View holidays and institution off days',
  },
  {
    name: 'holidays:create',
    resource: 'holidays',
    action: 'create',
    description: 'Create holidays and institution off days',
  },
  {
    name: 'holidays:update',
    resource: 'holidays',
    action: 'update',
    description: 'Update holidays and institution off days',
  },
  {
    name: 'shifts:read',
    resource: 'shifts',
  ...
  },
  {
    ...
    action: 'read',
    description: 'View biometric exemption requests',
  },
  {
    name: 'biometric-exemptions:approve',
    resource: 'biometric-exemptions',
    action: 'approve',
    description: 'Approve biometric exemption requests',
  },
  {
    name: 'attendance-punches:read',
    resource: 'attendance-punches',
    action: 'read',
    description: 'View attendance punches',
  },
  {
    name: 'attendance-approvals:approve',
    resource: 'attendance-approvals',
    action: 'approve',
    description: 'Approve supervised daily attendance',
  },
  {
    name: 'hr-attendance-approvals:approve',
    resource: 'hr-attendance-approvals',
    action: 'approve',
    description: 'Approve daily attendance for payroll readiness',
  },
  {
    name: 'ifmis-attendance:read',
    resource: 'ifmis-attendance',
    action: 'read',
    description: 'View HR-approved attendance prepared for IFMIS',
  },
  {
    name: 'ifmis-attendance:push',
    resource: 'ifmis-attendance',
    action: 'push',
    description: 'Push a complete payroll month to IFMIS',
  },
  {
    name: 'reports-attendance-daily:read',
    resource: 'reports-attendance-daily',
    action: 'read',
    description: 'View attendance daily report',
  },
  {
    name: 'reports-attendance-punches:read',
    resource: 'reports-attendance-punches',
    action: 'read',
    description: 'View attendance punches report',
  },
  {
    name: 'reports-late-attendance:read',
    resource: 'reports-late-attendance',
    action: 'read',
    description: 'View late attendance report',
  },
  {
    name: 'reports-overtime:read',
    resource: 'reports-overtime',
    action: 'read',
    description: 'View overtime report',
  },
  {
    name: 'reports-leave-balances:read',
    resource: 'reports-leave-balances',
    action: 'read',
    description: 'View leave balances report',
  },
  {
    name: 'reports-leave-requests:read',
    resource: 'reports-leave-requests',
    action: 'read',
    description: 'View leave requests report',
  },
  {
    name: 'reports-employees:read',
    resource: 'reports-employees',
    action: 'read',
    description: 'View employee roster report',
  },
  {
    name: 'reports-device-sync:read',
    resource: 'reports-device-sync',
    action: 'read',
...
const SYSTEM_ROLES = [
  ...
  {
    name: 'finance',
    description: 'Finance user with IFMIS attendance review and export access',
    permissions: ['ifmis-attendance:read', 'ifmis-attendance:push'],
  },
  {
    name: 'supervisor',
