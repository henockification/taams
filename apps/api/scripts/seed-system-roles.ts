...
const PERMISSIONS = [
  ...
  { name: 'temporary-assignment:read', resource: 'temporary-assignment', action: 'read', description: 'View temporary department assignments' },
  { name: 'temporary-assignment:add', resource: 'temporary-assignment', action: 'add', description: 'Create temporary department assignments' },
  { name: 'temporary-assignment:edit', resource: 'temporary-assignment', action: 'edit', description: 'Update temporary department assignments' },
